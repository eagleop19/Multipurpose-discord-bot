  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        let button_tutorial = new MessageButton().setStyle('LINK').setEmoji("840260133686870036").setLabel("YOUTUBE").setURL("https://youtube.com/c/REFLEXESPORTSINDIA")
        let menuOptions = [
          {
            label: "Overview",
            value: "Overview",
...
<:MilratoDevelopment:900389724936609842>  Coded by [**Milrato Development**](https://discord.gg/milrato)
<:emoji_1:959407637378785290>  Hosted by [**Deadly**](https://discord.gg/sBKcF7jH9X)`)
